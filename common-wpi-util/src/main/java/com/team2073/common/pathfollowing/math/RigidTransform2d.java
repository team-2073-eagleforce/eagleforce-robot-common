package com.team2073.common.pathfollowing.math;


import java.awt.geom.Point2D;

import static com.team2073.common.pathfollowing.math.Util.epsilonEquals;
...
public class RigidTransform2d implements Interpolable<RigidTransform2d> {
	...
	public static RigidTransform2d fromPoint(Point2D point, double angleInRads) {
		return new RigidTransform2d(new Translation2d(point.getX(), point.getY()), Rotation2d.fromRadians(angleInRads));
	}
