...
public interface Interpolable<T> {
     ...
     * return this value. If x is 1, the method should return the other value. If x between 0 and 1, the return value should be
     ...
     * @return Interpolable The estimated average between the surrounding data
     */
