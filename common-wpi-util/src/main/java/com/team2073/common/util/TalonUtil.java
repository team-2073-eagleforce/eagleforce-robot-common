...
public class TalonUtil {
	...
	public static class Configuration {
		...
		public int QUAD_ENCODER_STATUS_FRAME_RATE_MS = 10; /* default is 100ms, using 10 to match robot loops */
	 ...
	 * @return the talon
	 */
	public static IMotorControllerEnhanced resetTalon(IMotorControllerEnhanced talon) {
		Configuration config = kDefaultConfiguration;
